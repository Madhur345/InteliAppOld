...
public class BaseTest implements IAutoConstant{
	...
	{
		try{
			Keyword.click("HAMBURER_MENU");
		}catch(Exception e){
			e.printStackTrace();
			Reporter.log("Failed to Click on Hamburger Menu",true);
		}
		finally{
	...
	public void closeApplicationAndEndReport() throws Exception{
		try{
			Keyword.click("LOGOUT_LINK");
		}
		catch(Exception e){
			e.printStackTrace();
			Reporter.log("Fail to Click on Logout Link",true);
			extentTest.log(LogStatus.FAIL, "Failed to click Logout Link");
